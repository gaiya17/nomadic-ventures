...
export default function Page() {
  ...
  const tour = getTour(slug as string);
  ...
  const related = Object.values(TOURS)
    .filter((t) => t.slug !== tour.slug && t.tag === tour.tag)
    .slice(0, 3);
  const fillRelated = related.length < 3
    ? [
        ...related,
        ...Object.values(TOURS)
          .filter((t) => t.slug !== tour.slug && !related.find((r) => r.slug === t.slug))
