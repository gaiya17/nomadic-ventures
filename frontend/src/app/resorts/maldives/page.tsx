...
import { slugifyResort } from "@/data/resorts";
import {
  ArrowUpRight,
  ChevronRight,
  Star,
...
export default function Page() {
  const [heroId, setHeroId] = useState(COLLECTIONS[0].id);
  const heroCol = COLLECTIONS.find((c) => c.id === heroId)!;
              ...
              <div className="relative max-w-[1400px] mx-auto">
                ...
                >
                  ...
                  >
                    {/* Big featured */}
                    <div
                      onClick={() => navigate(`/resorts/maldives/${slugifyResort(c.resorts[0].name)}`)}
                      ...
                      <div className="absolute top-6 left-6 flex items-center gap-2">
                        ...
                        >
                          <span
                            ...
                            style={{ background: "#89F3FF" }}
                          />
                          FEATURED · {c.resorts[0].atoll.toUpperCase()}
                        </span>
                      </div>
                ...
                >
                  {c.resorts.map((r) => (
                    <div
                      key={r.name}
                      onClick={() => navigate(`/resorts/maldives/${slugifyResort(r.name)}`)}
